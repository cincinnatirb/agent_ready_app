...
class ParcelsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create parcel" do
    assert_difference("Parcel.count") do
      post parcels_url, params: { parcel: { city: @parcel.city, state: @parcel.state, street1: @parcel.street1, street2: @parcel.street2, zip_code: @parcel.zip_code } }
    end
  ...
  test "should update parcel" do
    patch parcel_url(@parcel), params: { parcel: { city: @parcel.city, state: @parcel.state, street1: @parcel.street1, street2: @parcel.street2, zip_code: @parcel.zip_code } }
